...
def user_details(request, user_id):
    ...
    borrowed_books = issueBookData.objects.filter(user=user).select_related('book').order_by('-issue_date')
    return render(request, 'UserDetails.html', {"user": user, "borrowed_books": borrowed_books})
